...
def convert_scoreboard_to_template(scoreboard):
    ...
    if scoreboard.blue_team.conclusion == "VICTORY":
        winner += scoreboard.blue_team.short_name
    elif scoreboard.red_team.conclusion == "VICTORY":
        winner += scoreboard.red_team.short_name
    team1bans = str()
...
def convert_player_info_to_template(team_color, player_number, player):
    player_intro = "|" + team_color + str(player_number+1) + "={{MatchRecapS4/Player|champion=" + player.champion_name + "|name=" + player.player_name + '\n'
    player_kda = "\t|kills=" + player.kills + "|deaths=" + player.deaths + "|assists=" + player.assists
    player_game_info = "|gold=" + player.gold + "|cs=" + player.cs + "|summonerspell1=" + player.summoner_spells[0].summoner_spell + "|summonerspell2=" + player.summoner_spells[1].summoner_spell + '\n'
    player_items = "\t|item1=" + player.items[0].item_name + "|item2=" + player.items[1].item_name + "|item3=" + player.items[2].item_name + "|item4=" + player.items[3].item_name + "|item5=" + player.items[4].item_name + "|item6=" + player.items[5].item_name + "|trinket=" + player.trinket.item_name
